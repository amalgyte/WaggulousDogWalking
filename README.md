...
- Owner console for approving or declining bookings, assigning walkers, and maintaining services/prices.
- Walker workspace for authorised jobs with pickup and return logging.
