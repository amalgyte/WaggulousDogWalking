...
- Firebase-backed authentication data with customer, admin, and walker roles.
...
- Admin: `admin@waggulous.com`
- Initial password: `Admin123!`

Use the Account tab after login to change the password.
