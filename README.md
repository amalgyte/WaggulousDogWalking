...
- Owner console for approving or declining bookings, assigning walkers, reassigning staff appointments, adding verbal client bookings, maintaining services/prices with configurable multi-pet pricing, and registering staff.
- Staff records with name, address, phone, email, avatar, login credentials, and owner-controlled self-assignment permission.
- Staff workspace for authorised jobs, approved-staff verbal client booking, next-7-day unassigned request and appointment claiming with approval confirmation, profile maintenance, avatar updates, and all-day or timed start/end availability management.
